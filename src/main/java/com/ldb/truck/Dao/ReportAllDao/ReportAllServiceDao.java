...
public class ReportAllServiceDao implements ReportAllDao {
    ...
    public List<ReportAll> ListAllReport(@RequestBody ReportAllReq reportAllReq) {
        try {
            ...
            if (reportAllReq.getStartDate() == null && !reportAllReq.getStatus().equals(0)) {
                ...
                sql = "select * from V_RE_ALL where D_STATUS ='" + reportAllReq.getStatus()
                        + "' and  DETAILS_DATE between '" + reportAllReq.getStartDate() + "' and '"
                        + reportAllReq.getEndDate() + "' ";
            }
    ...
    public List<ReportAll> ListAllReport_product(@RequestBody ReportAllReq reportAllReq) {
        try {
            if (reportAllReq.getStartDate() == null) {
                ...
                sql = "select * from V_REPORT_CUSTOMER where DETAILS_DATE between '" + reportAllReq.getStartDate()
                        + "' and '" + reportAllReq.getEndDate() + "' ";
            }
            return EBankJdbcTemplate.query(sql, new RowMapper<ReportAll>() {
                @Override
                public ReportAll mapRow(ResultSet rs, int rowNum) throws SQLException {
    ...
    public List<ReportAll> ListAllReportCustomer(@RequestBody ReportAllReq reportAllReq) {
        try {
            if (reportAllReq.getStartDate() == null) {
                sql = "select * from V_REPORT_PRODUCT a INNER JOIN LOGIN b ON a.userId=b.KEY_ID WHERE b.BRANCH='"
                        + reportAllReq.getBranch() + "'";
            } else {
                sql = "select * from V_REPORT_PRODUCT a INNER JOIN LOGIN b ON a.userId=b.KEY_ID where b.BRANCH='"
                        + reportAllReq.getBranch() + "' AND a.DETAILS_DATE between '" + reportAllReq.getStartDate()
                        + "' and '" + reportAllReq.getEndDate() + "' ";
            }
            return EBankJdbcTemplate.query(sql, new RowMapper<ReportAll>() {
                @Override
        ...
        try {
            if (reportAllReq.getStartDate() == null && reportAllReq.getStatus().equals("A")) {
                sql = "select '1' as type,   a.PRICE,a.TOTAL_PRICE,a.PRIECENUMNUN,a.STAFT_ID,a.STAFT_NAME,a.STAFT_SURNAME,a.STAFT_ID1,a.STAFT_NAME1,a.STAFT_SURNAME1,\n"
                        ...
                        +
                        "0 as total  \n" +
                        "from V_RE_ALL a inner join LOGIN b ON a.userId=b.KEY_ID where b.BRANCH='"
                        + reportAllReq.getBranch() + "'  \n";
                log.info("sql:" + sql);
                ...
                sql = "select '1' as type, a.PRICE,a.TOTAL_PRICE,a.PRIECENUMNUN,a.STAFT_ID,a.STAFT_NAME,a.STAFT_SURNAME,a.STAFT_ID1,a.STAFT_NAME1,a.STAFT_SURNAME1,\n"
                        ...
                        "0 as total\n" +
                        "from V_RE_ALL a inner join LOGIN b ON a.userId=b.KEY_ID where b.BRANCH='"
                        + reportAllReq.getBranch() + "' AND a.d_status ='" + reportAllReq.getStatus() + "'\n";
                log.info("sql:" + sql);
            } else if ((reportAllReq.getStartDate() != null) && (reportAllReq.getEndDate() != null)
                    && (reportAllReq.getStatus().equals("A"))) {
                sql = "select '1' as type, a.PRICE,a.TOTAL_PRICE,a.PRIECENUMNUN,a.STAFT_ID,a.STAFT_NAME,a.STAFT_SURNAME,a.STAFT_ID1,a.STAFT_NAME1,a.STAFT_SURNAME1,\n"
                        +
                        " a.H_VICIVLE_NUMBER,a.H_VICIVLE_BRANCHTYPE,a.F_BRANCH,a.F_CARD_NO,a.F_CAR_TYPE,a.PROVINCE,a.DETAIL,a.PROVINCE1,a.DETAIL1,a.CUSTOMER_ID,a.CUSTOMER_NAME,a.PRODUCT_ID,a.PRO_NAME,a.PRO_TYPE,a.PRODUCT_AMOUNT,a.PRODUCT_SIZE,a.PRODUCT_DETAILS,a.PRODUCT_FROM,a.PRODUCT_TO,a.PLACE_PD_FROM,a.PLACE_PD_TO,a.STAFF_ID_NUM1,a.STAFF_ID_NUM2,a.STAFF_BIALIENG,a.STAFF_BIALIENG_FRIST,\n"
                        +
                        ...
                        "0 as total\n" +
                        "from V_RE_ALL a inner join LOGIN b ON a.userId=b.KEY_ID where b.BRANCH='"
                        + reportAllReq.getBranch() + "' AND a.D_STATUS IN ('N', 'Y') AND a.OUT_DATE BETWEEN '"
                        + reportAllReq.getStartDate() + "' and '" + reportAllReq.getEndDate() + "'";
            } else if ((reportAllReq.getStartDate() == null) && (reportAllReq.getEndDate() == null)
                    && (!reportAllReq.getStatus().equals("A"))) {
                sql = "select '1' as type, a.PRICE,a.TOTAL_PRICE,a.PRIECENUMNUN,a.STAFT_ID,a.STAFT_NAME,a.STAFT_SURNAME,a.STAFT_ID1,a.STAFT_NAME1,a.STAFT_SURNAME1,\n"
                        +
                ...
                sql = "select '1' as type, a.PRICE,a.TOTAL_PRICE,a.PRIECENUMNUN,a.STAFT_ID,a.STAFT_NAME,a.STAFT_SURNAME,a.STAFT_ID1,a.STAFT_NAME1,a.STAFT_SURNAME1,\n"
                        ...
                        "from V_RE_ALL a inner join LOGIN b ON a.userId=b.KEY_ID where b.BRANCH='"
                        + reportAllReq.getBranch() + "' AND a.D_STATUS = '" + reportAllReq.getStatus()
                        + "' and a.OUT_DATE BETWEEN '" + reportAllReq.getStartDate() + "' and '"
                        + reportAllReq.getEndDate() + "'";
            }
            return EBankJdbcTemplate.query(sql, new RowMapper<ReportAll>() {
                @Override
                public ReportAll mapRow(ResultSet rs, int rowNum) throws SQLException {
                    ...
                    double allLaiyJaiy = countTotalNummun + conVertStaff02_beforepay + conVertStaffbialieng02
                            + conVertStaffbialieng01 + conVertStaffbialieng + conVertRunningTotal;
    ...
    public List<ReportFuel> ReportFuealDao(@RequestBody ReportAllReq reportAllReq) {
        try {
            if (reportAllReq.getStartDate() == null && reportAllReq.getStatus_fuel() == null
                    && reportAllReq.getFuelStationId() == null) {
                sql = "select * from V_RE_ALL a inner join LOGIN b ON (a.userId=b.KEY_ID) JOIN FUEL_STATION f ON (a.FUEL_STATION_ID = f.FUEL_STATION_ID) where b.BRANCH='"
                        + reportAllReq.getBranch() + "'  \n";
                log.info("SQL.1:" + sql);
            } else if ((reportAllReq.getStartDate() != null) && (reportAllReq.getStatus_fuel() != null)
                    && reportAllReq.getFuelStationId() == null) {
                log.info("SQL.2:" + sql);
                sql = "select * from V_RE_ALL a inner join LOGIN b ON (a.userId=b.KEY_ID) JOIN FUEL_STATION f ON (a.FUEL_STATION_ID = f.FUEL_STATION_ID) where b.BRANCH='"
                        + reportAllReq.getBranch() + "'  AND a.FUEL_STATUS = '" + reportAllReq.getStatus_fuel()
                        + "' and a.OUT_DATE BETWEEN '" + reportAllReq.getStartDate() + "' and '"
                        + reportAllReq.getEndDate() + "'";
            } else if ((reportAllReq.getStartDate() != null) && (reportAllReq.getEndDate() != null)
                    && (reportAllReq.getStatus_fuel() == null)) {
                log.info("SQL.3:" + sql);
                sql = "select * from V_RE_ALL a inner join LOGIN b ON (a.userId=b.KEY_ID) JOIN FUEL_STATION f ON (a.FUEL_STATION_ID = f.FUEL_STATION_ID) where b.BRANCH='"
                        + reportAllReq.getBranch() + "'  AND a.FUEL_STATUS in ('P','UP') and a.OUT_DATE BETWEEN '"
                        + reportAllReq.getStartDate() + "' and '" + reportAllReq.getEndDate() + "'";
            } else if ((reportAllReq.getStartDate() == null) && (reportAllReq.getEndDate() == null)
                    && (reportAllReq.getStatus_fuel() != null)) {
                log.info("SQL.5:" + sql);
                sql = "select * from V_RE_ALL a inner join LOGIN b ON (a.userId=b.KEY_ID) JOIN FUEL_STATION f ON (a.FUEL_STATION_ID = f.FUEL_STATION_ID) where b.BRANCH='"
                        + reportAllReq.getBranch() + "'  AND a.FUEL_STATUS = '" + reportAllReq.getStatus_fuel() + "'";
            } else if ((reportAllReq.getFuelStationId() != null) && (reportAllReq.getStartDate() != null)
                    && (reportAllReq.getEndDate() != null) && (reportAllReq.getStatus_fuel() != null)) {
                log.info("SQL.6:" + sql);
                sql = "select * from V_RE_ALL a join LOGIN b ON (a.userId=b.KEY_ID) JOIN FUEL_STATION f ON (a.FUEL_STATION_ID = f.FUEL_STATION_ID) where b.BRANCH='"
                        + reportAllReq.getBranch() + "'  AND f.FUEL_STATION_ID='" + reportAllReq.getFuelStationId()
                        + "' AND a.FUEL_STATUS = '" + reportAllReq.getStatus_fuel() + "'  and a.OUT_DATE BETWEEN '"
                        + reportAllReq.getStartDate() + "' and '" + reportAllReq.getEndDate() + "'";
            } else if (reportAllReq.getFuelStationId() != null && reportAllReq.getStartDate() == null
                    && reportAllReq.getEndDate() == null && reportAllReq.getStatus_fuel() == null) {
                log.info("SQL.7:" + sql);
    ...
    public List<ForShowTotalOilPaid> ShowOilPaid(@RequestBody ReportAllReq reportAllReq) {
        try {
            if (reportAllReq.getStartDate() == null) {
                sql = "select * from SPEND_OILS a inner join LOGIN b ON (a.userId=b.KEY_ID) where b.BRANCH='"
                        + reportAllReq.getBranch() + "'";
            } else {
                sql = "select * from SPEND_OILS a inner join LOGIN b ON a.userId=b.KEY_ID where b.BRANCH='"
                        + reportAllReq.getBranch() + "' AND a.DATECREATE BETWEEN '" + reportAllReq.getStartDate()
                        + "' AND '" + reportAllReq.getEndDate() + "'";
            }
        ...
        try {
            if (reportAllReq.getStartDate() == null && reportAllReq.getStatus().equals("A")) {
                sql = "select '1' as type,   a.PRICE,a.TOTAL_PRICE,a.PRIECENUMNUN,a.STAFT_ID,a.STAFT_NAME,a.STAFT_SURNAME,a.STAFT_ID1,a.STAFT_NAME1,a.STAFT_SURNAME1,\n"
                        ...
                        +
                        "                                                sum (TOTAL) as total from V_EXPENSES where STATUS in('PAY') AND BRANCH='"
                        + reportAllReq.getBranch() + "' ";
            } else if (reportAllReq.getStartDate() == null && !(reportAllReq.getStatus().equals("A"))) {
                sql = "select '1' as type, a.PRICE,a.TOTAL_PRICE,a.PRIECENUMNUN,a.STAFT_ID,a.STAFT_NAME,a.STAFT_SURNAME,a.STAFT_ID1,a.STAFT_NAME1,a.STAFT_SURNAME1,\n"
                        +
                ...
                sql = "select '1' as type, a.PRICE,a.TOTAL_PRICE,a.PRIECENUMNUN,a.STAFT_ID,a.STAFT_NAME,a.STAFT_SURNAME,a.STAFT_ID1,a.STAFT_NAME1,a.STAFT_SURNAME1,\n"
                        ...
                        "0 as STAFF_BIALIENG_CUR,0 as totalDay,0 as RunningTotal,\n" +
                        "sum (TOTAL) as total from V_EXPENSES where STATUS in ('PAY') AND BRANCH='"
                        + reportAllReq.getBranch() + "' and EXPDATE BETWEEN '" + reportAllReq.getStartDate() + "' and '"
                        + reportAllReq.getEndDate() + "'";

                // sql ="SELECT * FROM V_RE_ALL WHERE D_STATUS IN ('N', 'Y') AND DETAILS_DATE
                // BETWEEN '" + reportAllReq.getStartDate() + "' and '" +
                // reportAllReq.getEndDate() + "' ";
            } else if ((reportAllReq.getStartDate() == null) && (reportAllReq.getEndDate() == null)
                    && (!reportAllReq.getStatus().equals("A"))) {
                sql = "select '1' as type, a.PRICE,a.TOTAL_PRICE,a.PRIECENUMNUN,a.STAFT_ID,a.STAFT_NAME,a.STAFT_SURNAME,a.STAFT_ID1,a.STAFT_NAME1,a.STAFT_SURNAME1,\n"
                        ...
                        +
                        "0 as total\n" +
                        "from V_RE_ALL a inner join LOGIN b ON a.userId=b.KEY_ID where a.D_STATUS = '"
                        + reportAllReq.getStatus() + "' AND b.BRANCH='" + reportAllReq.getBranch() + "'" +
                        "union\n" +
                        "select '2' as type,\n" +
                        "0 PRICE,0 as TOTAL_PRICE,0 as PRIECENUMNUN,0 as STAFT_ID,0 as STAFT_NAME,0 as STAFT_SURNAME,0 as STAFT_ID1,0 as STAFT_NAME1,\n"
                        +
                ...
                sql = "select '1' as type, a.PRICE,a.TOTAL_PRICE,a.PRIECENUMNUN,a.STAFT_ID,a.STAFT_NAME,a.STAFT_SURNAME,a.STAFT_ID1,a.STAFT_NAME1,a.STAFT_SURNAME1,\n"
                        ...
                        +
                        "0 as total\n" +
                        "from V_RE_ALL a inner join LOGIN b ON a.userId=b.KEY_ID where BRANCH='"
                        + reportAllReq.getBranch() + "' AND a.D_STATUS = '" + reportAllReq.getStatus()
                        + "' and a.OUT_DATE BETWEEN '" + reportAllReq.getStartDate() + "' and '"
                        + reportAllReq.getEndDate() + "'" +
                        "union\n" +
                        ...
                        "0 as STAFF_BIALIENG_CUR,0 as totalDay,0 as RunningTotal,\n" +
                        "sum (TOTAL) as total from V_EXPENSES where STATUS in ('PAY') AND BRANCH='"
                        + reportAllReq.getBranch() + "'  and EXPDATE BETWEEN '" + reportAllReq.getStartDate()
                        + "' and '" + reportAllReq.getEndDate() + "'";
                // sql = "select * from V_RE_ALL where D_STATUS = '"+reportAllReq.getStatus()+"'
                // and DETAILS_DATE between '" + reportAllReq.getStartDate() + "' and '" +
                // reportAllReq.getEndDate() + "' ";
    ...
    public double getSumExpenses(ReportAllReq reportAllReq) {
        ...
        try {
            if (reportAllReq.getStartDate() == null) {
                sql = "select COALESCE(sum(TOTAL), 0) as total from V_EXPENSES where STATUS in('PAY') AND BRANCH='"
                        + reportAllReq.getBranch() + "'";
            } else {
                sql = "select COALESCE(sum(TOTAL), 0) as total from V_EXPENSES where STATUS in('PAY') AND BRANCH='"
                        + reportAllReq.getBranch() + "' and EXPDATE BETWEEN '" + reportAllReq.getStartDate() + "' and '"
