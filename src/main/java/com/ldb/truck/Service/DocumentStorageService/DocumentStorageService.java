...
public class DocumentStorageService {
    ...
    public Messages HeaderTruckFileUpdateService(OnlyFileHeaderTuckReq onlyFileHeaderTuckReq) {
        ...
        // //============================get User info=======================
        // List<Profile> userIn =
        // profileDao.getProfileInfoByToken(onlyFileHeaderTuckReq.getToKen());
        // log.info("show=================UserNo:"+userIn.get(0).getUserId());
        // log.info("show=================UserBname:"+userIn.get(0).getBranchName());
        // log.info("show=================Role:"+userIn.get(0).getRole());
        // log.info("show================BranchNo:"+userIn.get(0).getBranchNo());
    ...
    // //============================get User info=======================
    // List<Profile> userIn =
    // profileDao.getProfileInfoByToken(assetsOfficeReq.getToKen());
    // log.info("show=================UserNo:"+userIn.get(0).getUserId());
    // log.info("show=================UserBname:"+userIn.get(0).getBranchName());
    // log.info("show=================Role:"+userIn.get(0).getRole());
    // log.info("show================BranchNo:"+userIn.get(0).getBranchNo());
    ...
    public ListNameRes ListNameDeptServices(@RequestBody DeptMustReceivedReq deptMustReceivedReq) {
        ...
        try {
            ...
            double totalMoneydb = Data.stream().map(ListNameModel::getTotalPrice)
    ...
    // accept service
    public DeptMustReceivedRes AcceptTheReqDeptMustReceiveService(
            @RequestBody DeptMustReceivedReq deptMustReceivedReq) {
    ...
    public DeptMustReceivedRes DeptMustReceivedServicesdetail(@RequestBody DeptMustReceivedReq deptMustReceivedReq) {
        ...
        // //============================get User info=======================
        // List<Profile> userIn =
        // profileDao.getProfileInfoByToken(deptMustReceivedReq.getToKen());
        // log.info("show=================UserNo:"+userIn.get(0).getUserId());
        // log.info("show=================UserBname:"+userIn.get(0).getBranchName());
        // log.info("show=================Role:"+userIn.get(0).getRole());
        // log.info("show================BranchNo:"+userIn.get(0).getBranchNo());
    ...
    public CustomerHisPayRes DeptMustReceivedServicesHisCustomer(@RequestBody DeptMustReceivedReq deptMustReceivedReq) {
        ...
        try {
            ...
            double price_yet = Data.stream().map(CustomerHisPayModel::getMoney_T_jaiy)
                    .collect(Collectors.summingDouble(Double::doubleValue));
    ...
    public CustomerHisPayRes SearchDeptMustReceivedServicesHisCustomer(
            @RequestBody DeptMustReceivedReq deptMustReceivedReq) {
        // log.info("toKen=======================:"+deptMustReceivedReq.getToKen());
        // //============================get User info=======================
        // List<Profile> userIn =
    ...
    public FileOfHeaderRes ShowFilesOfHeadertruckKeyIdService(
            @RequestBody OnlyFileHeaderTuckReq onlyFileHeaderTuckReq) {
        // log.info("toKen=======================:"+onlyFileHeaderTuckReq.getToKen());
        // //============================get User info=======================
        // List<Profile> userIn =
        // profileDao.getProfileInfoByToken(onlyFileHeaderTuckReq.getToKen());
